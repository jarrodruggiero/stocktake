...
ABOUT = """Portfolio export
Generated by the portfolio tracker. All money columns are AUD unless the header
says "native"; each row is converted at its own FX rate.
